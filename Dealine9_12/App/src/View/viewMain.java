...
public class viewMain extends JFrame {
    ...
    public void initComponent() {
        ...
        this.add(jSC, BorderLayout.EAST);
        this.pack();
    ...
    public void addTableFromDB(User user) {
        DefaultTableModel m1 = (DefaultTableModel) table.getModel();
        Object[] o = { user.getName(), user.getAddress(), user.getMark() };
        m1.addRow(o);
    }

    public void addTable() {
        DefaultTableModel m1 = (DefaultTableModel) table.getModel();
        Object[] o = { txtName.getText(), txtAddress.getText(), Double.parseDouble(txtMark.getText()) };
        m1.addRow(o);
    }

    public void removeTable(int indexRow) {
        DefaultTableModel m1 = (DefaultTableModel) table.getModel();
        m1.removeRow(indexRow);
    }

    public void repairTable(int indexRow) {
        DefaultTableModel m1 = (DefaultTableModel) table.getModel();
        Object[] o = { txtName.getText(), txtAddress.getText(), Double.parseDouble(txtMark.getText()) };
        m1.removeRow(indexRow);
        m1.insertRow(indexRow, o);
    }

    public boolean checkNameField() {
        if (txtName.getText().isEmpty() || txtAddress.getText().isEmpty() || txtMark.getText().isEmpty()) {
            return true;
        }
        return false;
    }
