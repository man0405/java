                ...
                Statement stmt = con.createStatement();
                    ...
                    switch (flag) {
                        ...
                        case 2:
                            ...
                            break;
                        case 3:
                            String sqlUpdate = "Update Student set Name =N'"+userCurrent.getName()+"' , Address = N'"+userCurrent.getAddress()+"' , Mark ="+userCurrent.getMark()+" Where Name = N'Hello' and Address = N'DN' and Mark = 8";
