                ...
                Statement stmt = con.createStatement();
                    ...
                    switch (flag) {
                        ...
                        case 2:
                            ...
                            break;
                        case 3:
                            String sqlUpdate = "Update Student set Name =N'"+userCurrent.getName()+"' , Address = N'"+userCurrent.getAddress()+"' , Mark ="+userCurrent.getMark()+" Where Name = (SELECT Name FROM Student ORDER BY [Order] ASC OFFSET 1 ROWS FETCH NEXT 1 ROW ONLY) AND Address = (SELECT Address FROM Student ORDER BY [Order] ASC OFFSET 1 ROWS FETCH NEXT 1 ROW ONLY) AND Mark = (SELECT Mark FROM Student ORDER BY [Order] ASC OFFSET 1 ROWS FETCH NEXT 1 ROW ONLY);
                    ";
                        default:
                            break;
                    }
